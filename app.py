...
#Creating the function to accept inputs and creating an 2nd array and predicting the results
...
if __name__=="__main__":
    ...
    if submit_button:
        larger_text=f"<h2 style='color:black;'>The Predicted Price is: {result} Lakhs</h2>"
